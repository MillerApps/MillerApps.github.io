...
3. **Configure Encryption:**
   ...
   - Setup Lets Encrypt certs using Certbot:
     ...
     2. Run in terminal: `sudo certbot certonly --manual --preferred-challenges=dns --preferred-chain="ISRG Root X1"` or if root use `certbot certonly --manual --preferred-challenges=dns --preferred-chain="ISRG Root X1"`
